        ...
        <div className="system"  id="system">
            <div className="container width" ref={domRef}>
                <div className="row">
                    ...
                    <div className="col-1"><div className="vr vr-blurry hr-size"></div></div>
                    ...
                    <div className="col-4 pa-top-10">
                        <img src="/kasse.jpg" className="img-fluid" />
                    </div>
                    <div className="col-1 pa-top-10"><div className="vr vr-blurry hr-size"></div></div>
