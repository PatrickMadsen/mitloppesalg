export default () => {
    return(
        <div className="system height-100">
            <div className="container">
                <div className="row">
                    <h2 className="text-center fs-1 pb-5">Vores system</h2>
                    <img src="/computer-ipad.png" className="img-fluid col-4 mt-5" />
                    <div className="col-1"><div class="vr vr-blurry hr-size"></div></div>
                    ...
                    <img src="/kasse.jpg" className="img-fluid col-4 pa-top-10" />
                    <div className="col-1 pa-top-10"><div class="vr vr-blurry hr-size"></div></div>
                    <div className="col-7 pa-top-10">
                        <h3>Kasseudstyr</h3>
