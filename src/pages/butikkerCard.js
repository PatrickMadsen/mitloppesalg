    ...
    return(
      <>
        <div className="col-4 text-center mb-2">
          <img className="rounded-circle" src="/genbrugsmarked-1.jpg" alt="Genbrugs marked" />
        ...
        <div className="col-4 text-center mb-2">
          <img className="rounded-circle" src="/fundoglund.jpg" alt="Genbrugs marked" />
        ...
        <div className="col-4 text-center mb-2">
          <img className="rounded-circle" src="/shopiloppen.jpg" alt="Genbrugs marked" />
